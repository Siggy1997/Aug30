...
public class Util {
	...
	public boolean simpleMailSender(Map<String, Object> map) throws EmailException {
		...
		// 메일 정보 적기
		String emailAddr = "159753martin@naver.com"; // 보내는 사람
		String passwd = "johnjohn1!"; // 보내는 사람의 메일 암호 넣기
		String name = "관리자";
		...
		mail.setDebug(false);// 메일이 어떻게 날아가는지 문제가 없는지 정보가 콘솔창에 뜸
	...
	public void htmlMailSender(Map<String, Object> map) throws EmailException {
		...
		String file2 = path + "/20230822144805a7268516-72ad-4fc5-9cef-05c1604fe661SpringBoot+Thymeleaf.docx";

		String html = "<html>"; // 코드가 길어지니 여기서 작업해서 넣어줄게요
		html += "<h1>그림을 첨부합니다</h1>";
		// html+="<img src='"+img+"'>";
	      html += "<img alt=\"이미지\" src='"+img+"'>";
		html += "<h2>임시비밀번호를 보내드립니다.<h2>";
		html += "<div>임시 암호 : 45679845671564894534768415674654168</div>";
		html += "<h3>아래링크를 클릭해서 암호를 변경해주세요.<h3>";
